...
function get_conexion()
{
    ...
    return $conexion; //Delvolver la variable conexion
}

function seleccionar_bd_tienda($conexion)
{
    return $conexion->select_db("tiendas");//No tiene bien el nombre de la ddbb
}
...
{
    $sql = "CREATE DATABASE IF NOT EXISTS tiendas";
